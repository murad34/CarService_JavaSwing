    ...
    public void test() {
        ...
        sendbutton.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String NameAndSurnamestring = nameofownertextfield.getText();
                String NumberOfOwnerstring = numberofowenrtextfield.getText();
                String modelofcarstring = modelofcartextfield.getText();
                String NumberOfCarstirng = numberofcartextfield.getText();
                String dateofreceivingstring = String.valueOf(dateofreceivingchooser.getDate());
                String dateofgivingstring = String.valueOf(dateofgivingchooser.getDate());

                Statement statement;
                Connect_with_DB connectDB = new Connect_with_DB();

                try{
                    String sql="insert into maintable(nameandsurname,numberofowner,numberofcar,modelofcar,dateofreceiving,dateofgiving) " +
                            "values('"+NameAndSurnamestring+"','"+NumberOfOwnerstring+"','"+modelofcarstring+"','"+NumberOfCarstirng+"','"+dateofreceivingstring+"','"+dateofgivingstring+"')";
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    while(rs.next()){
                        ...
                        JTextField nameofowner_rs = new JTextField(rs.getString("NameAndSurname"));
                        nameofowner_rs.setBounds(755, 175, 130, 30);
                        frame.add(nameofowner_rs);

                        JTextField numberofowner_rs = new JTextField(rs.getString("NumberOfOwner"));
                        numberofowner_rs.setBounds(755, 215, 130, 30);
                        frame.add(numberofowner_rs);

                        JTextField modelofcar_rs = new JTextField(rs.getString("modelofcar"));
                        modelofcar_rs.setBounds(755, 255, 130, 30);
                        frame.add(modelofcar_rs);

                        JTextField numberofcar_rs = new JTextField(rs.getString("NumberOfCar"));
                        numberofcar_rs.setBounds(755, 295, 130, 30);
                        frame.add(numberofcar_rs);

                        DateFormat dateformat = new SimpleDateFormat("dd-MM-yyyy");
                        JTextField textField = new JTextField();
                        textField.setBounds(755,335,130,30);
                        textField.setText(dateformat.format(rs.getDate("dateofreceiving")));
                        frame.add(textField);

                        DateFormat dateformat2 = new SimpleDateFormat("dd-MM-yyyy");
                        JTextField textField2 = new JTextField();
                        textField2.setBounds(755,375,130,30);
